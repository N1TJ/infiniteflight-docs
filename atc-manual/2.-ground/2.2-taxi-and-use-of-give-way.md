...
"Taxi to RWYXX, contact tower when ready" and "Taxi to Parking" are the default commands that **must**{.red} be used by Controllers for the purposes of taxiing departing/arriving aircraft. Where available, Controllers **should**{.red} use the "drag and taxi" feature to issue specific taxi routes. Controllers **must**{.red} issue a crossing clearance to aircraft for each runway their route crosses (and an aircraft **must**{.red} have crossed a previous runway before another runway crossing clearance may be issued). In some cases, the "drag and taxi" feature will not instruct an aircraft to "Contact Tower when ready". Ground Control **should**{.red} initiate a handoff to Tower when approaching the departure runway if all conflicts are resolved. Jet-type aircraft do not need to be instructed to "Contact Tower when ready" due to the fact that they're assumed to be ready for departure upon reaching the departure runway. 
...
At large HUB airports with adequate runway length and multiple intersections (e.g. JFK) controllers **should**{.red} utilize available intersections to sequence departures and improve overall operational efficiency. Controllers **must**{.red} consider aircraft performance characteristics and airport elevation. 

Tip

: Utilizing an intersection prior to an intersecting runway can help expedite departures and remove the need to stagger arriving and departing aircraft 
